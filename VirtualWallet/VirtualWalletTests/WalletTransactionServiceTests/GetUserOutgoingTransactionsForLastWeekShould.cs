...
{
    [TestClass]
    public class GetUserOutgoingTransactionsForLastWeekShould
    {
        ...
        public void Return_TransactionsInUsd_When_HasTransactions()
        {
            ...
            var actualTransactions = walletTransactionService.GetUserOutgoingTransactionsForLastWeek(userId, toCurrency);
