...
namespace VirtualWallet.Web.Helper
{
	public class ImageManager : IImageManager
	{
		...
		public async Task<string> UploadGeneratedProfilePicInRoot(IFormFile generatedPic)
		{
		...
		public async Task<string> UploadOriginalProfilePicInRoot(IFormFile originalPic)
		{
			...
			using (FileStream fileStream = new FileStream(serverFolder, FileMode.Create))
			{
				await originalPic.CopyToAsync(fileStream);
			}
			return "/" + folder;
		}
