...
![Alt text](https://github.com/NGK02/sparki-virtual-wallet/blob/main/ImagesForREADME/HomePageDark.png)
...
* If you try to access the any other user's data without being an admin. You will be greeted by our awesome custom error page!
    <br><br>
    ![Alt text](https://github.com/NGK02/sparki-virtual-wallet/blob/main/ImagesForREADME/ErrorPageDark.gif)
    <br><br>
## Responsive design
* Here are some screencaps from out app on mobile to show it is fully responsive!
    <br><br>
    ![Alt text](https://github.com/NGK02/sparki-virtual-wallet/blob/main/ImagesForREADME/Responsive.png)
    <br><br>
